    ...
    <MaxWidthWrapper>
      <div className="w-full py-10">
        <div className="flex items-center justify-end">
          <Link
            className="text-xl no-underline hover:underline text-orange-700 dark:text-orange-500"
            href="/survey"
          >
        ...
        <div className="flex items-center justify-center w-full mb-20">
          <div className="flex w-full flex-col space-y-10 items-center">
            ...
            <p className="text-xl">
              Sign in to Ra&apos;Nkan or{" "}
              <span>
                <Link
                  className="no-underline hover:underline text-orange-700 dark:text-orange-500"
                  href="/register"
                >
                  create an account
                </Link>
            ...
            <div className="flex flex-row items-center space-x-28 w-full">
                        ...
                        <FormItem>
                          <FormControl>
                            <div className="grid w-full place-self-start gap-3">
                              ...
                              <Input
                                className="border-black border-2 h-12"
                                type="email"
                                id="email"
                                {...field}
                              />
              ...
              <div className="w-full flex flex-col space-y-10">
                ...
                <div className="relative">
                  <button
                    className="text-2xl font-bold h-16 w-96 border-black border-2 rounded-full"
                    onClick={GoogleOauth}
                  >
                ...
                <div className="relative">
                  <button
                    className="text-2xl text-slate-100 font-bold h-16 w-96 border-black border-2 rounded-full bg-blue-600"
                    onClick={GoogleOauth}
                  >
